...
/**
 * Partial update DTO. All fields are optional; non-null values will be applied.
 */
public class UserUpdateRequest {
    ...
    private String locoPilotId;    // optional
    ...
    private String mobNo;          // optional

    private Set<RoleAssignmentDto> roles = new HashSet<>(); // optional replacement
